 ...
 */
public interface DeviceControlCallbackDAO {
    //
    DeviceControlCallbackForDB retrieveDeviceControlCallback(long id);
    ...
    String updateDeviceControlCallback(long id, DeviceControlCallbackData deviceControlCallbackData);
    String deleteDeviceControlCallback(long id);
}
